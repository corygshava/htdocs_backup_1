...
<head>
    ...
    <title>Sarova hotel management system</title>

    <!-- Bootstrap -->
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/iconic.css" rel="stylesheet">
...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/home _banner1.jpeg" style="width:100%; height:200px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
                ...
                <br>
                <p>Online hotel reservations are also helpful for making last minute travel arrangements. Hotels may drop the price of a room if some rooms are still available. </p>
            </div>  
        </div>
