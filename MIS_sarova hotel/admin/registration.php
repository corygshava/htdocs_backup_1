...
<head>
    <title>Sarova hotel : user registration</title>
    <meta charset="utf-8">
        ...
        <div class="well">
            ...
            <form action="" method="post" name="reg">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fullname" placeholder="example: Henry Olunga" required>
                </div>
                <div class="form-group">
                    <label for="uname">User Name:</label>
                    <input type="text" class="form-control" name="uname" placeholder="exmple: henryitez" required>
                </div>
                <div class="form-group">
                    <label for="uemail">Email:</label>
                    <input type="email" class="form-control" name="uemail" placeholder="example: henryolunga62@gmail.com" required>
                </div>
                <div class="form-group">
