...
<head>
    ...
    <title>Sarova hotel book room</title>
            ...
            <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="e.g Brian Kimanthi" required>
                </div>
                <div class="form-group">
                    <label for="phone">Enter Your Phone Number:</label>
                    <input type="text" class="form-control" name="phone" placeholder="+254741441574" required>
                </div>
