<?php
	...
	include 'workers/worker_listusers.php';	
?>
...
<body>
		...
		<div class="tableguy">
			<div class="tableholder">
				<div class="w3-center anc">
					...
					<hr>
					<span>showing <b><?php echo $reccount;?></b> users</span>
				</div>
				<table class="w3-table w3-bordered w3-striped w3-hoverable w3-card-4">
					...
					<tbody>
						...
						<tr class="ender">
							<td colspan="9">
								<a href="new_user.php" class="btn w3-hover-blue"><i class="fa fa-plus"></i> add new user</a>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<script>
		...
		function deleteRsv(n) {
			...
			pop.querySelector('h2').innerHTML = 'mark as read?';
			pop.querySelectorAll('.btn.themehover')[1].innerHTML = '<i class="fa fa-check"></i> mark as read';
