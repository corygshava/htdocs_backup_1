...
if(!isset($_SESSION['admin_name'])){  
    ...
    $date=date('m/d/Y');
    $sel=mysqli_query($db, "SELECT * FROM `payments` WHERE `payment_type`='weekly'");
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php $curpage="pay weekly";include 'admin_navbar.php';?>

            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Users Paying Weekly</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>   
