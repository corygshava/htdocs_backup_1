...
if(!isset($_SESSION['admin_name'])){  
    ...
    $date=date('m/d/Y');
    $sel=mysqli_query($db, "SELECT * FROM `payments` WHERE `valid_untill`<='$date'");
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php $curpage="passed_validity";include 'admin_navbar.php';?>

            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Passed Validity date</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>   
