...
<?php 
    ...
    $deposits = $tsales = $tpaid = $available_balance = $tea_leaves = $coffee_powder = 0;
    ...
    // Get itemamt for "tea leaves" from inventory
    $query_tea_leaves = "SELECT itemamt FROM inventory WHERE itemname = 'tea leaves'";
    $result_tea_leaves = mysqli_query($conn, $query_tea_leaves);
    if ($row = mysqli_fetch_assoc($result_tea_leaves)) {
        $tea_leaves = $row['itemamt'];
    }

    // Get itemamt for "tea" from inventory
    $query_coffee_powder = "SELECT itemamt FROM inventory WHERE itemname = 'tea'";
...
<body>
	...
	<div class="content">
		<div class="summary">
			...
			<section class="w3-center">
				...
				<div class="item">
					...
					<div class="thing">
						<h5>total profit</h5>
						<span class="num show_profits">1,434,365</span>
					</div>
				</div>
			</section>
				...
				<section class="w3-col m6">
					...
					<div class="info">
						...
						<div class="item2">
							...
							<span>tea available</span>
						</div>
						<div class="item2">
							<b class="tag coffee_lost">0kg</b>
							<span>leaves spoilt in processing</span>
						</div>
						<div class="item2">
							<b class="tag coffee_complete">450kg</b>
							<span>leaves processed successfully</span>
						</div>
						<div class="item2">
							<b class="tag coffee_processing">450kg</b>
							<span>tea in processing</span>
						</div>
					</div>
				</section>
				<section class="w3-col m6">
					<h3 class="">Extra data</h3>
					<div class="info">
						<div class="item2">
		...
		<div class="ops" style="margin-bottom: 220px;">
			<div class="w3-center">
				<h1>welcome <b class="themetxt"><?php echo $curuser;?></b></h1>
				<hr>
			</div>
			<div class="w3-center">
				<h2>Operations</h2>
			...
			<div class="w3-row">
				<div class="w3-col m4">
					...
					<div class="opslist">
						...
						<a href="sell_coffee.php">sell tea</a>
				...
				<div class="w3-col m4">
					<h3 class="pritxt">tea Operations</h3>
					<div class="opslist">
	...
	<script>
		...
		*/
		...
		var profit = <?php if($total_profit == ''){echo 0;}else{echo $total_profit;};?>;
		...
		var cofee_seeds = <?php if($tea_leaves == ''){echo 0;}else{echo $tea_leaves;};?>;
		...
		var show_profits = document.querySelector('.show_profits');
		...
		function initUI() {
			...
			show_profits.innerHTML = `${profit.toLocaleString()}`;
			show_profits.className += profit > 0 ? ' pritxt' : ' w3-text-red';
