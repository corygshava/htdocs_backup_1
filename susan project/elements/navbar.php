	...
	<div>
		...
		<div class="w3-dropdown-hover">
			...
			<div class="w3-dropdown-content w3-card w3-animate-opacity">
				...
				<a href="sell_tea.php" class="navlink">sell tea</a>
				<a href="sales_tea.php" class="navlink">tea sales</a>
			</div>
		</div>

		<div class="w3-dropdown-hover">
			<a href="#" class="opter"><i class="fa fa-coffee"></i> tea options <i class="fa fa-chevron-down"></i></a>
			<div class="w3-dropdown-content w3-card w3-animate-opacity">
