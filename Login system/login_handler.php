<?php
    if(isset($_POST['op'])){
        ...
        if($operation == "login"){
            // in case the user wants to log into an existing user (login)
            ...
            if($totalrows > 0){
                ...
                echo "The username doesnt exist on this server";
            }
        } else {
            ...
            if($totalrows > 0){
                ...
                // add new record
                $myop = "INSERT INTO users (userid,username,password) VALUES (NULL,'".$username."','".$password."')";
                $workonit = false;
                echo $myop."<br>";
