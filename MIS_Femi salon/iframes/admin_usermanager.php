...
<?php
    /*
        ...
        if it is{
            open a table called users and display all the records where the field called ('user_role') is not set to 'worker' in a table like manner
...
if (isset($_GET['key']) && $_GET['key'] === '123') {
    // Retrieve records where user_role is not 'worker'
