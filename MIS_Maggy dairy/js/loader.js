...
`.loader {
	...
	`
		.loader {
		  width: 40px;
		  height: 20px;
		  --c:no-repeat radial-gradient(farthest-side,var(--mycol) 93%,#0000);
		  background:
		    var(--c) 0    0,
		    var(--c) 50%  0,
		    var(--c) 100% 0;
...
.loader::before {
  border-color: var(--themecolor) #0000;
  animation: inherit; 
...
/*
	...
	2 	- nice loader
	4	- infinite loader
	7	- infinite loader (bars)
	9	- jump, jump drop
	18	- fun little game 2
	19 	- another infinite loader
	14	- morpher
	22	- boxy infinite loader
	23	- loading bar
	24	- [doesnt work]
	25	- the most satisfying loader
	26	- saving to flash disk
	27	- img loader
	28	- hourglass
	29	- clocker
	30	- water bottle loader
	31	- saving to cloud
	32	- shredding
	33	- printer loader
	34	- jump, jump, jump
	...
	36	- bars nope
	37	- spinning loader
	38	- another spinning loader
*/

function spawnloader(n,holder,color) {
	...
	if(loadguy.querySelector('.extratxt') != undefined){
		loadguy.querySelector('.extratxt').innerHTML = `loader number ${n}`;
	}
	...
	if(color != undefined){
		loadguy.style.setProperty('--mycol',color);
	}
}