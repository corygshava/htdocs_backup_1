...
<body>
    ...
    <div class="formholder">
        <div class="theform">
            <h1 class="w3-center">New sale of coffee seeds</h1>
            <div class="w3-center">
                <span>available coffee</span><br>
    ...
    <script>
        ...
        var avl_coffee = <?php echo $avl_coffee;?>;
        ...
        function initUI() {
            avlshow.innerHTML = `${avl_coffee} KG`;
            amtnpt.max = avl_coffee;
