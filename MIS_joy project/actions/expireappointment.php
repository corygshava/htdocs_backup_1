<?php
    ...
    if(isset($_GET['theappointmentserial'])) {
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            $updateQuery = "UPDATE appointments SET appointmentstatus = 'expired' WHERE appointmentserial = '$appointmentSerial'";
            if(mysqli_query($conn, $updateQuery)) {
                echo "Appointment with serial number <b>$appointmentSerial</b> has been updated successfully.";
            } else {
