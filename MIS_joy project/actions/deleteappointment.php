<?php
    ...
    if(isset($_GET['theappointmentserial'])) {
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            $updateQuery = "DELETE FROM appointments WHERE appointmentserial = '$appointmentSerial'";

            if(mysqli_query($conn, $updateQuery)) {
                echo "Appointment with serial number <b>$appointmentSerial</b> has been deleted successfully.";
            } else {
